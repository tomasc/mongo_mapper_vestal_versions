module MongoMapper::Plugins::VestalVersions
  # Ties into the existing MongoMapper::Document#reload method to ensure that version information
  # is properly reset.
  module Reload
    ...
    module InstanceMethods
      # Overrides MongoMapper::Document#reload, resetting the instance-variable-cached version number
