module MongoMapper::Plugins::VestalVersions
  ...
  module Users
    ...
    module VersionMethods
      ...
      def user_with_name
        return nil if user_without_name.nil? && user_name.nil?
        user_without_name.nil? ? user_name : user_without_name
      end
      ...
      def user_with_name=(value)
        case value
          when MongoMapper::Document then self.user_without_name = value
