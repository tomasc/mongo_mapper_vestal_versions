# +vestal_versions+ keeps track of updates to MongoMapper models.
# By storing only the updated attributes in a serialized column of a
# single version model, the history is kept DRY and no additional schema changes are necessary.
#
# Author:: Steve Richert
# MongoMapper port:: Tomas Celizna
