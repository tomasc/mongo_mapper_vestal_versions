...
class OptionsTest < Test::Unit::TestCase
  context 'Configuration options' do
    setup do
      ...
      @configuration.each{|k,v| MongoMapper::Plugins::VestalVersions::Configuration.send("#{k}=", v) }
  ...
  context 'Given no options, configuration options' do
    ...
    should 'default to "VestalVersions::Version" for :class' do
      assert_equal 'MongoMapper::Plugins::VestalVersions::Version', @prepared_options[:class].to_s
    end
